...
delays and transcription errors. - **Data Accessibility:** Limited connectivity in
growing areas prevented real-time data collection and reporting. - **Data Quality:**
Inconsistent data entry standards resulted in unreliable analytics. - **Reporting
Delays:** Manual data aggregation meant stakeholders couldn't access timely insights.
...
- **Data Processing:** Azure Data Factory for ETL processes
- **Data Lake:** Azure Data Lake Storage for raw and processed data
